...
I had the chance to visit the theoretical group of Karl Friston at Wellcome Trust Centre for Neuroimaging (University College London) from November 2010 to February 2012. This led to a collaboration on modelling eye movements using active inference [Friston *et al*, 2012]({{< relref "/publication/friston-12" >}}) in persons with or without schizophrenia [Adams *et al*, 2012]({{< relref "/publication/adams-12" >}}). Notably, we established a model accounting for sensory-motor delays [Perrinet *et al*, 2014]({{< relref "/publication/perrinet-adams-friston-14" >}}).


* {{< cite page="/publication/friston-12" view="citation" >}}
* {{< cite page="/publication/adams-12" view="citation" >}}
* {{< cite page="/publication/perrinet-adams-friston-14" view="citation" >}}
