 ...
 * Dauce, E., Albiges, P., & Perrinet, L. U. (2020). A dual foveal-peripheral visual processing model implements efficient saccade selection. Journal of Vision, 20(8), 22-22. <https://hal.archives-ouvertes.fr/hal-02947410/>\
 * Dauce, E., & Perrinet, L. (2020, September). Visual Search as Active Inference. In International Workshop on Active Inference (pp. 165-178). Springer, Cham. <https://hal.archives-ouvertes.fr/hal-03084758/>\
