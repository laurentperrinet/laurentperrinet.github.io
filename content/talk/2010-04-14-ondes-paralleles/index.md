...
abstract: 'En perception, les neurones « parlent » tous en même temps par de brèves
  ...
  plus rapides. Ils sont construits avec pour modèle la grammaire humaine autour d''une
  unité centrale, car on imaginait la cognition sous cet angle à leur invention. Le
  bit est le quantum d''un algorithme mécanique (thèse de Church-Turing). Une théorie
  tranche par rapport à la précédente, proposée par «von Neumann» : beaucoup d''unités
