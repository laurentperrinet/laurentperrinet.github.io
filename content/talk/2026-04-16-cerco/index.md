...
abstract: 'Working memory, the ability to store and retrieve precise temporal patterns
  ...
  a synthetic benchmark of M=8 patterns (N=512 neurons, T=1000 steps), training with
  surrogate-gradient backpropagation achieves a mean F1 score of 0.966, with recall
  emerging near the clamped window and propagating forward in time. Our results demonstrate
