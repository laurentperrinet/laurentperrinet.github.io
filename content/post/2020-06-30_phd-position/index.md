...
subtitle: Offre de thèse "Vision ultra-rapide par réseaux de neurones impulsionnels" à Marseille
...
Applications are welcome for a doctoral position at [INT](http://www.int.univ-amu.fr/?lang=en) in [Marseille](https://en.wikipedia.org/wiki/Marseille), France. Your mission will be to build ultra-fast vision algorithms using spiking neural networks. The project is funded by the [APROVIS3D](https://laurentperrinet.github.io/grant/aprovis-3-d/) grant (ANR-19-CHR3-0008-03) from the French National Research Agency (ANR) and will be coordinated by [Laurent Perrinet](https://laurentperrinet.github.io/). We are seeking candidates with a strong background in machine learning, computer vision and computational neuroscience.
