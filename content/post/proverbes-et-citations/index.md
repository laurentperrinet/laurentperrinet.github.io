\+++ title = "Proverbes Et Citations" summary = "Proverbes et citations glanés au cours des années"
...
* “**Harry Potter:**\
  ...
  **Professor Albus Dumbledore:**\
  Of course it is happening inside your head, Harry, but why on earth should that mean that it is not real?” ―**J.K. Rowling, [Harry Potter and the Deathly Hallows](https://www.goodreads.com/work/quotes/2963218)**
...
* Nos idées doivent être aussi vastes que la nature pour pouvoir en rendre compte." [Arthur Conan Doyle](http://www.evene.fr/citations/auteur.php?ida=813&celebrite=arthur-conan-doyle%7C)
