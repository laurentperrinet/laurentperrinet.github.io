...
*Hello*, can you hear me in the back? First, I'd like to *thank* organizers for this opportunity, and all of you for coming. These slides are available from my website, along with a number of references.

I'm Laurent Perrinet from the Institut des Neurosciences de la Timone, a joint AMU / CNRS unit, and I'm a computational neuroscientist interested in large scale models of vision. during this seminar for the "groupe de recherche de la vision de l'UdeM", I'll be focusing on neuromorphic models, by presenting to you *event-driven cameras*, a new technology in the field of imaging, and the impact of this technology on our understanding of vision. The *outline* of the talk is as follows: initially, I will explain the concept of an event-driven camera, especially in comparison to a traditional frame-based camera. Following that, we’ll explore some applications of these cameras using specific algorithms. Lastly, we’ll delve into how our understanding of neuroscience can enhance these algorithms.
{{< /speaker_note >}}
...
{{< speaker_note >}}
First of all, the objective of *imaging technologies* is to represent a visual signal, which includes luminous intensity and color, distributed over the visual field to create a realistic representation of a visual scene. Let's see an example.
{{< /speaker_note >}}
...
{{< speaker_note >}}
For example, this galloping horse gives us the feeling that we’re seeing a scene right in front of us. This imaging technique allowed by the chain of preocesses from my computer to the beamer seems to move smoothly, but it’s actually an *illusion* called apparent motion. This happens when still images are shown one after another, very quickly, making it look like the scene is moving. Our brains interpret these separate images as a single unified moving scene. This technique is the foundation of motion pictures and animation, where frames are displayed quickly enough to give the *illusion* of continuous motion.
{{< /speaker_note >}}
...
{{< speaker_note >}}
The use of such dynamic *visualization* is crucial in the scientific field, whether in biology or physics, as it enables us to quantify the characteristics of the experiment being carried out. 
In the laboratory, for example, we use it in particular to quantify *eye movements* when a stimulus is presented to an observer.
