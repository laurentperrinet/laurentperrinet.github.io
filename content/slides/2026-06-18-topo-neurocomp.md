...
###	<u>[Centre de neurosciences computationnelles](https://conect-int.github.io)</u>
###	[2026-06-18]
...
{{< speaker_note >}}
Bonjour, je me présente : Laurent Perrinet. 

L'objectif de cet exposé est de présenter les neurosciences computationnelles en l'abordant d'abord par la vision.
{{< /speaker_note >}}
...
[Illusions de luminosité ou de clarté *Akiyoshi KITAOKA*](http://www.ritsumei.ac.jp/~akitaoka/index-e.html)
...
{{< speaker_note >}}
- ...plongeons dans une théorie computationnelle de la vision
{{< /speaker_note >}}
...
{{< speaker_note >}}
- c'est un modèle complexe, à plusieurs échelles...
- peut-être ne pourrons-nous jamais le comprendre entièrement
- les mots ne sont pas assez précis ; utilisons les mathématiques et les modèles pour décrire ce système
{{< /speaker_note >}}
...
{{< speaker_note >}}
- et un modèle de ce système...(https://biology.stackexchange.com/questions/10955/ventral-stream-pathway-and-architecture-proposed-by-poggios-group)
- les CNN, les modèles fondateurs de l'apprentissage profond
{{< /speaker_note >}} 
...
{{< speaker_note >}}
- zoomons : l'ingrédient de base est le champ récepteur
{{< /speaker_note >}}
