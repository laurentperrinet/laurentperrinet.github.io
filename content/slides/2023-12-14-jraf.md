...
{{< speaker_note >}}
Why is detecting a very wide range of luminosity usefull ? The ability to *adapt* to changing light conditions can be illustrated by revisiting our analog signal and its event representation. Consider, for example, an autonomous car driving in daylight and then entering and exiting a *tunnel*. This scenario involves changes in brightness by a factor of several thousand.
