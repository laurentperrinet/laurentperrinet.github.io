...
{{< speaker_note >}}
This technique is inspired by the research carried out by Étienne-Jules *Marey* (https://en.wikipedia.org/wiki/Étienne-Jules_Marey), under the term *chronophotography*, litterally shooting scene with a gun-like apparatus, which notably enabled later Muybridge to demonstrate the mechanism of a horse's gallop. In particular, Marey literally used a camera mounted on a *gun*-like structure to shoot a visual scene. 
{{< /speaker_note >}}
