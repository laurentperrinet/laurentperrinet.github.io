...
abstract: 'This study investigates the use of Riemannian geometry to detect and monitor
  ...
  performing a Simon’s task after inducing MWL by the Multi Attribute Task Battery-II
  (MATB), aimed to differentiate low and high workload conditions while tracking MWL
  effect over time. Using covariance matrices and a Minimum Distance to Mean classifier,
  Temporal Generalization Method (TGM) was used to assess stable decoding performance,
