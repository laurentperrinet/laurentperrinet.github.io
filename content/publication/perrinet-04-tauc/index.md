...
abstract: A goal of low-level neural processes is to build an efficient code extracting
  ...
  problem in the case where the signal may be described by a robust linear gen- erative
  ...
  implementation using a network of spiking integrate-and-fire neu- rons which communicate
  ...
  natural images. Even though it is simplistic, this trans- formation of spatial data
