...
* this proceedings paper follows up he poster presented in : {{< cite page="/publication/grimaldi-21-cosyne" view="citation" >}}
* this proceedings paper was followed by the poster presented at CRS : {{< cite page="/publication/grimaldi-21-crs" view="citation" >}}
* read the follow-up paper : {{< cite page="/publication/grimaldi-23" view="citation" >}}
