...
![](@commsbio_1673229104353509377_tweetcapture.png)
...
{{< figure src="Artboard.png" title="Figure 1. Les images naturelles (ici, une vue des calanques de Marseille), sont décomposées en éléments orientés (en bas à gauche) par des réseaux de neurones, dont les interactions sont contraintes par l'incertitude locale qui décrit des parties du champ visuel." alt="Natural images (a view of the calanques of Marseille) decomposed into oriented elements by neural networks whose interactions are constrained by local uncertainty." numbered="true" >}}
...
{{< figure src="microcicuit.png" title="Figure 2 La variation du code des neurones face a une augmentation d'incertitude dépend de leur position dans le cortex (a, b), un phénomène expliqué par une activité récurrente plus intense pour les neurones encodant l'incertitude." alt="Neuronal code variation with increasing uncertainty depends on cortical position, explained by stronger recurrent activity for uncertainty-encoding neurons." numbered="true" >}}
