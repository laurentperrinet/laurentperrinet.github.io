...
abstract: $<$p$>$What are the neural mechanisms underlying motion integration of translating
  ...
  evokes a sequence of transient feedforward responses in the primary visual cortex
  but also propagations of activity through horizontal and feedback pathways. We investigated
  how these pathways shape the representation of a translating bar in monkey V1. We
  show that, for long trajectories, spiking activity builds-up hundreds of milliseconds
  before the bar enters the neurons receptive fields. Using VSDI and LFP recordings
...
publication_types:
- '2'
publishDate: 2020-03-31 09:09:18.618547+00:00
